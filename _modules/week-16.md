...
| Experimental design & evaluation | Baselines; appropriate metrics; ablations/sensitivity; error/limitation analysis | 5 |
| Contribution / insight | A clearly stated "new bit" (method/system/study); justified design decisions | 5 |
| Reproducibility & documentation | Run instructions; config/seeds; data paths; organized results & figure-generation scripts | 3 |
